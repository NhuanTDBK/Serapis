  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Review.reviewers.findById() instead.
        "prototype$__findById__reviewers": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Reviews/:id/reviewers/:fk",
          method: "GET"
        },

        // INTERNAL. Use Review.reviewers.destroyById() instead.
        "prototype$__destroyById__reviewers": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Review.reviewers.updateById() instead.
        "prototype$__updateById__reviewers": {
          params: {
          'fk': '@fk'
          },
        ...
        // INTERNAL. Use Review.reviewers() instead.
        "prototype$__get__reviewers": {
          isArray: true,
          url: urlBase + "/Reviews/:id/reviewers",
          method: "GET"
        },

        // INTERNAL. Use Review.reviewers.create() instead.
        "prototype$__create__reviewers": {
          url: urlBase + "/Reviews/:id/reviewers",
          method: "POST"
        },

        // INTERNAL. Use Review.reviewers.destroyAll() instead.
        "prototype$__delete__reviewers": {
          url: urlBase + "/Reviews/:id/reviewers",
          method: "DELETE"
        },

        // INTERNAL. Use Review.reviewers.count() instead.
        "prototype$__count__reviewers": {
          url: urlBase + "/Reviews/:id/reviewers/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Review.reviewers.create() instead.
        "::create::Review::reviewers": {
          url: urlBase + "/Reviews/:id/reviewers",
          method: "POST"
        },

        // INTERNAL. Use Review.reviewers.createMany() instead.
        "::createMany::Review::reviewers": {
          isArray: true,
          url: urlBase + "/Reviews/:id/reviewers",
          method: "POST"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Review.reviewers
     * @header lbServices.Review.reviewers
     * @object
     * @description
     *
     * The object `Review.reviewers` groups methods
     * manipulating `Review` instances related to `Review`.
     *
     * Call {@link lbServices.Review#reviewers Review.reviewers()}
     * to query all related instances.
     */
        ...
        R.reviewers = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::get::Review::reviewers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Review.reviewers#count
         * @methodOf lbServices.Review.reviewers
         *
         * @description
         *
         * Counts reviewers of Review.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.reviewers.count = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::count::Review::reviewers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Review.reviewers#create
         * @methodOf lbServices.Review.reviewers
         *
         * @description
         *
        ...
        R.reviewers.create = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::create::Review::reviewers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Review.reviewers#createMany
         * @methodOf lbServices.Review.reviewers
         *
         * @description
         *
        ...
        R.reviewers.createMany = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::createMany::Review::reviewers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Review.reviewers#destroyAll
         * @methodOf lbServices.Review.reviewers
         *
         * @description
         *
        ...
        R.reviewers.destroyAll = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::delete::Review::reviewers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Review.reviewers#destroyById
         * @methodOf lbServices.Review.reviewers
         *
         * @description
         *
        ...
        R.reviewers.destroyById = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::destroyById::Review::reviewers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Review.reviewers#findById
         * @methodOf lbServices.Review.reviewers
         *
         * @description
         *
        ...
        R.reviewers.findById = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::findById::Review::reviewers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Review.reviewers#updateById
         * @methodOf lbServices.Review.reviewers
         *
         * @description
         *
        ...
        R.reviewers.updateById = function() {
          var TargetResource = $injector.get("Review");
          var action = TargetResource["::updateById::Review::reviewers"];
          return action.apply(R, arguments);
        };
